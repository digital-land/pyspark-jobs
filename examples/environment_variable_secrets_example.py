...
def main():
    ...
    # Convert secret name to environment variable name (dev/pyspark/postgres -> SECRET_DEV_PYSPARK_POSTGRES)
    ...
    try:
        ...
        secret_json = get_secret_emr_compatible("dev/pyspark/postgres")
