...
class FactResourceTransformer:
    ...
    def transform(df):
        ...
        """
        try:
            logger.info("FactResourceTransformer: Transforming data for Fact Resource table")
            ...
            logger.info(f"FactResourceTransformer: Transformation complete, columns: {transf_df.columns}")
            return transf_df
