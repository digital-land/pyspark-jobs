...
def create_temp_log_file(
    prefix: str = "test_", suffix: str = ".log", in_test_logs: bool = True
) -> str:
    """
...
def ensure_test_logs_gitignored() -> bool:
    ...
    test_logs_patterns = ["tests/logs/", "tests/**/*.log"]

    return all(pattern in gitignore_content for pattern in test_logs_patterns)


# Convenience functions for common test scenarios
def setup_test_file_logging(
    test_name: str, log_level: str = "DEBUG"
) -> tuple[str, object]:
    """
