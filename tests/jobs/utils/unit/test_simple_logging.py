"""
Simple logging tests that verify the logger_config module works correctly.
These tests can be run with or without pytest.
"""
...
def test_logging_with_file():
    ...
    try:
        ...
        log_file = get_test_log_file("test_simple_logging_file")
