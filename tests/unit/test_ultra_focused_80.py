    ...
    def test_postgres_writer_utils_massive_gain(self):
        ...
        with patch.dict('sys.modules', {
            ...
            try:
                ...
                try:
                    write_dataframe_to_postgres_jdbc(mock_df, "test_table", connection_params)
                except Exception:
                    pass
                ...
                try:
                    _execute_atomic_transaction(mock_df, "test_table", connection_params)
                except Exception:
                    pass
        ...
        with patch.dict('sys.modules', {
            ...
            try:
                ...
                data_types = [
                    ...
                    "float", "double", "decimal(10,2)", "string", "varchar(255)",
                    "char(10)", "binary", "date", "timestamp",
                ...
                for data_type in data_types:
                    ...
                    with patch('jobs.csv_s3_writer.col') as mock_col, \
                         ...
                         patch('jobs.csv_s3_writer.lit') as mock_lit:
