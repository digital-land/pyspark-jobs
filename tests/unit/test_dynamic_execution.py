...
class TestDynamicExecution:
    ...
    def test_dynamic_postgres_writer_utils_execution(self):
        ...
        with patch.dict('sys.modules', mock_modules):
            ...
            # Mock PySpark types - use string names instead of Mock objects
            pyspark_types.LongType.return_value = 'LongType'
            pyspark_types.DateType.return_value = 'DateType'
            ...
            required_cols = [
                'entity', 'organisation_entity',  # bigint - existing and missing
                'json', 'new_json', 'geojson', 'geometry', 'point', 'quality', 'name', 'prefix', 'reference', 'typology', 'dataset',  # string
                'entry_date', 'new_entry_date', 'start_date', 'end_date',  # date - existing and missing
