...
class TestCreateSparkSession:
    ...
    def test_create_spark_session_failure(self, mock_logger, mock_spark_session):
        ...
        mock_spark_session.builder.appName.return_value.config.return_value.config.return_value.config.return_value.config.return_value.getOrCreate.side_effect = Exception(
            "Spark failed"
        )
...
class TestLoadMetadata:
    ...
    @patch("jobs.main_collection_data.get_logger")
    def test_load_metadata_filesystem_absolute_path(
        self,
        mock_logger,
        mock_normpath,
        mock_abspath,
    ...
    @patch("os.path.normpath")
    @patch("jobs.main_collection_data.get_logger")
    def test_load_metadata_path_traversal_protection(
        self,
        mock_logger,
        mock_normpath,
        mock_abspath,
...
class TestMainFunction:
    ...
    @patch("jobs.main_collection_data.get_logger")
    def test_main_spark_session_failure(
        self, mock_logger, mock_create_spark, mock_validate, mock_init_logging
    ):
    ...
    @patch("jobs.main_collection_data.create_spark_session")
    @patch("jobs.main_collection_data.get_logger")
    def test_main_invalid_load_type_in_processing(
        self, mock_logger, mock_create_spark, mock_validate, mock_init_logging
    ):
    ...
    @patch("jobs.main_collection_data.create_spark_session")
    @patch("jobs.main_collection_data.get_logger")
    def test_main_spark_stop_error(
        self, mock_logger, mock_create_spark, mock_validate, mock_init_logging
    ):
    ...
    @patch("jobs.main_collection_data.create_spark_session")
    @patch("jobs.main_collection_data.get_logger")
    def test_main_timing_calculation_error(
        self, mock_logger, mock_create_spark, mock_validate, mock_init_logging
    ):
