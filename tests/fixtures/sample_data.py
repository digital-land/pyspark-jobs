...
def sample_fact_data(spark):
    ...
    data = [
        ("fact1", "2023-12-31", "entity1", "field1", "2023-01-01", 1, "ref1", "2023-01-01", "value1", "1"),
        ("fact1", "2023-12-31", "entity1", "field1", "2023-01-02", 2, "ref1", "2023-01-01", "value2", "2"),
        ("fact2", "2023-12-31", "entity2", "field2", "2023-01-01", 1, "ref2", "2023-01-01", "value3", "3")
    ]
...
def sample_issue_data(spark):
    ...
    data = [
        ("entity1", "1", "field1", "validation", "1", "test-dataset", "resource1", "invalid_value", "Invalid value"),
        ("entity2", "2", "field2", "format", "2", "test-dataset", "resource2", "bad_format", "Format error")
    ]
