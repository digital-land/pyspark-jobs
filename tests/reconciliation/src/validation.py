...
class FileProcessor:
    ...
    def _process_csv(self, file_path: str) -> Dict[str, Any]:
        try:
            ...
            return {"file_type": "CSV", "record_count": 0, "is_valid": False, "error": str(e)}
    ...
    def _process_json(self, file_path: str) -> Dict[str, Any]:
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                entities = [r.get('entity', '') for r in records if isinstance(r, dict) and r.get('entity')]
                unique_entities = set(entities)
                return {
                    "file_type": "JSON",
            ...
            return {"file_type": "JSON", "record_count": 0, "is_valid": False, "error": str(e)}
    ...
    def _process_geojson(self, file_path: str) -> Dict[str, Any]:
        try:
            ...
            if not geojson_obj.is_valid:
                ...
                return {"file_type": "GeoJSON", "record_count": 0, "is_valid": False, 
                        "error": f"Invalid GeoJSON: {errors}", "validation_standard": "RFC 7946"}
            ...
            entities = [f.get('properties', {}).get('entity', '') for f in features if f.get('properties', {}).get('entity')]
            unique_entities = set(entities)
            ...
            return {"file_type": "GeoJSON", "record_count": 0, "is_valid": False, "error": str(e), "validation_standard": "RFC 7946"}
